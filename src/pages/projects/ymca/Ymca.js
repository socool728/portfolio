...
const title = 'NFT Art Generator (NFT INATOR)';
const description =
  'I worked as the Full Stack Developer and blockchain developer on a major iteration of NFT INATOR’s product. We took the platform in a bold new direction, focusing on becoming the best toolkit to accelerate design and development of procedurally generated NFT projects.';
                                      ...
                                      <div className="block-universal--subtitle text-center">
                                        <div className="clearfix text-formatted field field--name-field-subtitle field--type-text-long field--label-hidden field__item">
                                          <p>
                                            ...
                                            events. They create opportunities for people
                                            to thrive in an inclusive, open environment.
                                            We were hired to help them achieve this
                                            mission online – through an overhaul of their
                                            website and by integrating sophisticated, new
                                            functions.
                                          </p>
                                        </div>
                                      </div>
                                          ...
                                          <div className="paragraph paragraph--type--experience-value paragraph--view-mode--default">
                                            <div className="experience-value-wrapper">
                                              ...
                                              <div className="experience-value-description text-center">
                                                <div className="clearfix text-formatted field field--name-field-description field--type-text-long field--label-hidden field__item">
                                                  <p>
                                                    Simplified sitemap from over than
                                                    3,200 pages
                                                  </p>
                                                </div>
                                              </div>
                                          ...
                                          <div className="paragraph paragraph--type--experience-value paragraph--view-mode--default">
                                            <div className="experience-value-wrapper">
                                              ...
                                              <div className="experience-value-description text-center">
                                                <div className="clearfix text-formatted field field--name-field-description field--type-text-long field--label-hidden field__item">
                                                  <p>
                                                    Improved average session duration by
                                                    10%
                                                  </p>
                                                </div>
                                              </div>
                                          ...
                                          <div className="paragraph paragraph--type--experience-value paragraph--view-mode--default">
                                            <div className="experience-value-wrapper">
                                              ...
                                              <div className="experience-value-description text-center">
                                                <div className="clearfix text-formatted field field--name-field-description field--type-text-long field--label-hidden field__item">
                                                  <p>
                                                    Lowered bounce rate from 40% to 35%
                                                  </p>
                                                </div>
                                              </div>
                                            </div>
                                      ...
                                      <div className="block-universal--description">
                                        <div className="clearfix text-formatted field field--name-field-description field--type-text-long field--label-hidden field__item">
                                          ...
                                          <p>
                                            ...
                                            of what the client and its users expect as
                                            well as how they use the platform, we have
                                            chosen a ready-made theme of the
                                            <Link
                                            ...
                                            available theme, Carlos Jair was able to
                                            fulfill the budget constraint of
                                            <Link
                                              href="https://www.ymcapkc.org/"
                                              target="_blank"
                                              rel="nofollow"
                                      ...
                                      <div className="block-universal--description">
                                        <div className="clearfix text-formatted field field--name-field-description field--type-text-long field--label-hidden field__item">
                                          ...
                                          <p>
                                            ...
                                            eager Open Y community member. However,
                                            without having done any major update to their
                                            old website, their technology environment
                                            became outdated and error-prone. We were hired
                                            to update their entire website in order to
                                            enable the running of all the necessary
                                            functionality. By updating their entire web
                                            presence, we introduced a user-centric
                                          ...
                                          <ul>
                                            <li>
                                              Create a system with which updating to
                                              future versions is timely and financially
                                              efficient
                                            </li>
                                            <li>
                                            ...
                                            <li>
                                              Add modern sought-after functionalities to
                                              the website such as brand new program
                                              registration process, online membership and
                                              single sign-on
                                            </li>
                                          </ul>
                                        </div>
                                      ...
                                      <div className="block-universal--description">
                                        <div className="clearfix text-formatted field field--name-field-description field--type-text-long field--label-hidden field__item">
                                          ...
                                          <p>
                                            ...
                                            extensive range of various events and
                                            activities such as workouts. The old website
                                            of YMCA of Pierce and Kitsap Counties used a
                                            cumbersome list of events and places where
                                            these events take place. The developers
                                            recognized the tremendous impact a
                                            sophisticated
                                            <Link
                                  ...
                                  <div className="row">
                                    <div className="col-12">
                                      <div className="field field--name-field-result field--type-string-long field--label-hidden field__items row d-flex flex-wrap justify-content-center">
                                        ...
                                        <div className="field__item text-center col-12 col-md-6 col-lg-4">
                                          Decreased time required to add new events
                                          through intuitive backend
                                        </div>
                                        <div className="field__item text-center col-12 col-md-6 col-lg-4">
                                    ...
                                    <div className="col-12">
                                      ...
                                      <div className="block-universal--description">
                                        <div className="clearfix text-formatted field field--name-field-description field--type-text-long field--label-hidden field__item">
                                          ...
                                          <p>
                                            Consisting of many branches and locations,
                                            YMCA of Pierce and Kitsap Counties offers
                                            varying content depending on a user’s
                                            location. Our developers were asked to enable
                                            users to find relevant content based on their
                                            location. Carlos Jair recognized that, while a
                                            certain part of content will vary from
                                            location to location, most of the content will
                                            be identical. We solved this challenge by
                                            developing specific filters and
                                            <Link
                                            ...
                                            YMCA of Pierce and Kitsap Counties efficient
                                            and structured.&nbsp;When we had started with
                                            this migration project, we already knew that
                                            the YMCA of Pierce and Kitsap Counties will
                                            require a single sign-on solution to satisfy
                                            its members. To create a seamless solution, we
                                            have integrated
                                            <Link
                                            ...
                                            depends for its proper functioning but also
                                            made the personal account easily accessible
                                            from any website page.
                                          </p>
                                        </div>
                                      </div>
                                    </div>
                                  ...
                                  <div className="row">
                                    <div className="col-12">
                                      <div className="field field--name-field-result field--type-string-long field--label-hidden field__items row d-flex flex-wrap justify-content-center">
                                        ...
                                        <div className="field__item text-center col-12 col-md-6 col-lg-4">
                                          Increased user engagement by mapping user
                                          journeys
                                        </div>
                                        <div className="field__item text-center col-12 col-md-6 col-lg-4">
                                      ...
                                      <div className="block-universal--description">
                                        <div className="clearfix text-formatted field field--name-field-description field--type-text-long field--label-hidden field__item">
                                          ...
                                          <p>
                                            ...
                                            fulfilling their personal constraints.
                                            Moreover, the activity finder not only helps
                                            users to discover relevant events but also
                                            simplifies the registration process through a
                                    ...
                                    <div className="col-12">
                                      ...
                                      <div className="block-universal--description">
                                        <div className="clearfix text-formatted field field--name-field-description field--type-text-long field--label-hidden field__item">
                                          ...
                                          <p>
                                            Carlos Jair migrated and overhauled an
                                            existing website to harness the power of
                                            sophisticated functionalities such as single
                                            sign-on and data analytics. One of the
                                            overarching goals, however, was to foster
                                            efficient updating in the future. As our
                                            client is a community-focused non-profit
                                            organization, a cost-efficient updating
                                            process is a must. Therefore, our developers
                                            created synergies wherever possible and
                                            created an intuitive user interface as well as
                                            a backend to simplify all processes. In
                                            addition to that, we migrated the entire
                                            content onto the new website and demonstrated
                                            the data analytics capabilities to our client.
                                          </p>
                                  ...
                                  <div className="row">
                                    <div className="col-12">
                                      ...
                                      <div className="block-universal--description">
                                        <div className="clearfix text-formatted field field--name-field-description field--type-text-long field--label-hidden field__item">
                                          <h2>
                                            Long-term collaboration and further
                                            improvements
                                          </h2>
                                          ...
                                          <p>
                                            ...
                                            has been entirely satisfied with our
                                            transparent approach and trustworthiness. They
                                            have been praising their final website on
                                            several occasions, namely a monthly web
                                            streaming event available here on
                                            <Link
                                          ...
                                          <blockquote>
                                            <p>
                                              ...
                                              I’ve ever experienced. Their support
                                              services are impressive; if there’s ever an
                                              issue, they deliver 24/7 support. Whether
                                              it’s an issue on the website or a hosting
                                              concern, they support us in every way,
                                              shape, or form.&nbsp;They’re absolutely
                                              outstanding.
                                            </p>
                                          </blockquote>
